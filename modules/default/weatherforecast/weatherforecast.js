...
Module.register("weatherforecast",{
	...
	getDom: function() {
		...
		for (var f in this.forecast) {
			...
			maxTempCell.innerHTML = forecast.maxTemp.replace(".", this.config.decimalSymbol) + degreeLabel + cellSpace + forecast.minTemp.replace(".", this.config.decimalSymbol) + degreeLabel;
