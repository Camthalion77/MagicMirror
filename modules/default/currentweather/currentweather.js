...
Module.register("currentweather",{
	...
	getDom: function() {
		...
		if (!this.loaded) {
			...
			return wrapper;
                ...
                if (this.config.showFeelsLike){
                        var small = document.createElement("div");
                        small.className = "dimmed light mediumCustom";

                        var feelsLike = document.createElement("span");
                        feelsLike.className = "dimmed";

                        feelsLike.innerHTML = "Τώρα"; 
		...
		if (this.config.showFeelsLike && this.config.onlyTemp === false){
			...
			feelsLike.innerHTML = this.translate("&nbsp;" + "Αίσθηση") + " " + this.feelsLike + "&deg;" + degreeLabel;
	...
	processWeather: function(data) {
		...
		if (!data || !data.main || typeof data.main.temp === " ") {
